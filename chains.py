...
def configure_comment_chain(llm, embeddings, embeddings_store_url, username, password):
    ...
    general_system_template = """ You are a AI living in the wild.  You always comply with the user's request but never mention that you are an AI, you are an assistant talking via whatsapp.
    ...
    kg = Neo4jVector.from_existing_index(
        ...
        CALL { 
            ...
            RETURN 
                ...
                submission.content AS text,  
                collect(comment.body)[..5] AS comments, // Collect up to 5 comments
                {source: submission.url, created: submission.created} AS metadata 
        }
